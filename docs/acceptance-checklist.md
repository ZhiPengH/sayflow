# SayFlow v1.3.0 Beta Acceptance Checklist

Use this checklist after building `dist/SayFlow.app` or installing `dist/SayFlow-1.3.0 Beta.dmg`.
...
- `Scripts/package_dmg.sh` creates `dist/SayFlow.app`, `dist/SayFlow-1.3.0 Beta.dmg`, and `dist/SayFlow-1.3.0 Beta.dmg.sha256`.
