# SayFlow v1.2.9 Acceptance Checklist

Use this checklist after building `dist/SayFlow.app` or installing `dist/SayFlow-1.2.9.dmg`.
...
- `Scripts/package_dmg.sh` creates `dist/SayFlow.app`, `dist/SayFlow-1.2.9.dmg`, and `dist/SayFlow-1.2.9.dmg.sha256`.
