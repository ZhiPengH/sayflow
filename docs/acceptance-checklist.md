# SayFlow v1.2.1 Acceptance Checklist

Use this checklist after building `dist/SayFlow.app` or installing `dist/SayFlow-1.2.1.dmg`.
...
- `Scripts/package_dmg.sh` creates `dist/SayFlow.app`, `dist/SayFlow-1.2.1.dmg`, and `dist/SayFlow-1.2.1.dmg.sha256`.
