...
Use this checklist after building `dist/Graker.app` or installing `dist/Graker-1.0.0.dmg`.
...
- `Scripts/package_dmg.sh` creates `dist/Graker.app`, `dist/Graker-1.0.0.dmg`, and `dist/Graker-1.0.0.dmg.sha256`.
