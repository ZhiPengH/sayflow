# SayFlow v1.2.6 Acceptance Checklist

Use this checklist after building `dist/SayFlow.app` or installing `dist/SayFlow-1.2.6.dmg`.
...
- `Scripts/package_dmg.sh` creates `dist/SayFlow.app`, `dist/SayFlow-1.2.6.dmg`, and `dist/SayFlow-1.2.6.dmg.sha256`.
