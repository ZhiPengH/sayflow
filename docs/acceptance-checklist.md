# SayFlow v1.3.2 Acceptance Checklist

Use this checklist after building `dist/SayFlow.app` or installing `dist/SayFlow-1.3.2.dmg`.
...
- `Scripts/package_dmg.sh` creates `dist/SayFlow.app`, `dist/SayFlow-1.3.2.dmg`, and `dist/SayFlow-1.3.2.dmg.sha256`.
