...
public enum L10n {
    ...
    private static let translations: [AppLanguage: [L10nKey: String]] = [
        .english: [
            ...
            .invalidProviderBaseURL: "Base URL / Endpoint must be a valid HTTPS OpenAI-compatible endpoint (HTTP is allowed for localhost).",
        ...
        .chinese: [
            ...
            .invalidProviderBaseURL: "Base URL / Endpoint 必须是有效的 HTTPS OpenAI 兼容端点（localhost 可用 HTTP）。",
