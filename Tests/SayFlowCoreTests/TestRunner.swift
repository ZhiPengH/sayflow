...
struct SayFlowCoreTestRunner {
    static func main() {
        let tests: [TestCase] = [
            ...
            TestCase(name: "Prompt validation", run: PromptTemplateTests.validatorRejectsMissingTextPlaceholderAndEmptySystemPrompt),
            TestCase(name: "Prompt placeholder can live in either field", run: PromptTemplateTests.validatorAcceptsTextPlaceholderInEitherPromptField),
            TestCase(name: "Prompt store persistence", run: PromptTemplateTests.promptStoreCreatesDefaultFileAndPreservesCustomTemplate),
            TestCase(name: "Prompt store rejects externally invalid files", run: PromptTemplateTests.promptStoreRejectsInvalidTemplateFilesEditedExternally),
            ...
            TestCase(name: "Prompt import accepts valid templates", run: PromptTemplateTests.importPolicyAcceptsValidDecodedTemplates),
